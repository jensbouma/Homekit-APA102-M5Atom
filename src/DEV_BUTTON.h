struct DEV_Button : Service::StatelessProgrammableSwitch {       // Stateless Programmable Switch
 
  SpanCharacteristic *switchEvent;                  // reference to the ProgrammableSwitchEvent Characteristic
  
  DEV_Button(int buttonPin, int index) : Service::StatelessProgrammableSwitch(){
